    ...
    <section className="bg-[#FFDB57] dark:bg-[#FFDB57] relative pt-[120px] lg:pt-[15px] pb-[11px]">
        <div className="grid max-w-screen-xl px-4  pb-8 sm:grid-cols-1 sm:mt-3 md:grid-cols-1 md:m-10 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            <div className="mr-auto lg:col-span-7">
               ...
               High auto insurance & stressed like Anna?
                </h1>
                <p className="max-w-2xl mb-6 font-regular text-[#424242] md:p-5 lg:mb-8 md:text-lg lg:text-lg dark:text-zinc-700"> 
                  <span className="text-[#3f3e3e] font-semibold text-xl">We are building future of auto insurance & more. </span> <br/> 
                  We provide low premium for your auto insurance irrespective of your age, create your own policies and one tap claim process.
                  <br/> <br/><span className="text-[#3f3e3e] font-semibold"> Leave stress behind, take your ride with confidence. </span>
                </p>
